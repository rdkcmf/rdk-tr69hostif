 ...
 *
 * @brief TR-069 Device.InterfaceStack object Public API.
 *
 * Description of InterfaceStack module.
 *
 *
 * @par Document
 * Document reference.
...
/** @defgroup TR_069_DEVICE_INTERFACESTACK_API TR-069 Device.InterfaceStack object API.
 *  @ingroup TR_069_API
 *
