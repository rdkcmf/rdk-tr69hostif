...
public:
    ...
    char firmwareVersion[N_LENGTH];
    unsigned int maxBitRate;
    unsigned int maxIngressBW;
    unsigned int maxEgressBW;
    char highestVersion[N_LENGTH];
    char currentVersion[N_LENGTH];
    unsigned int networkCoordinator;
    unsigned int nodeId;
    bool maxNodes;
    bool preferredNC;
    unsigned int backupNC;
    bool privacyEnabledSetting;
    bool privacyEnabled;
    char freqCapabilityMask[FREQ_LENGTH];
    char freqCurrentMaskSetting[FREQ_LENGTH];
    char freqCurrentMask[FREQ_LENGTH];
    unsigned int currentOperFreq;
    unsigned int lastOperFreq;
    char keyPassphrase[S_LENGTH];
    unsigned int txPowerLimit;
    unsigned int powerCntlPhyTarget;
    unsigned int beaconPowerLimit;
    char networkTabooMask[FREQ_LENGTH];
    char nodeTabooMask[FREQ_LENGTH];
    unsigned int txBcastRate;
    unsigned int txBcastPowerReduction;
    bool qAM256Capable;
    unsigned int packetAggregationCapability;
    unsigned int associatedDeviceNumberOfEntries;
    unsigned int X_RDKCENTRAL_COM_MeshTableNumberOfEntries;

    MoCAInterface():enable(FALSE),upStream(TRUE) {
        strcpy(status,"Down");
    };
    ~MoCAInterface() {};
};

typedef enum EMoCAInterfaceMembers
{
    eMocaEnable=0,
    eMocaStatus,
    eMocaAlias,
    ...
    eMocaUpstream,
    eMocaMACAddress,
    eMocaFirmwareVersion,
    eMocaMaxBitRate,
    eMocaMaxIngressBW,
    eMocaMaxEgressBW,
    eMocaHighestVersion,
    eMocaCurrentVersion,
    eMocaNetworkCoordinator,
    eMocaNodeID,
    eMocaMaxNodes,
    eMocaPreferredNC,
    eMocaBackupNC,
    eMocaPrivacyEnabledSetting,
    eMocaPrivacyEnabled,
    eMocaFreqCapabilityMask,
    eMocaFreqCurrentMaskSetting,
    eMocaFreqCurrentMask,
    eMocaCurrentOperFreq,
    eMocaLastOperFreq,
    eMocaKeyPassphrase,
    eMocaTxPowerLimit,
    eMocaPowerCntlPhyTarget,
    eMocaBeaconPowerLimit,
    eMocaNetworkTabooMask,
    eMocaNodeTabooMask,
    eMocaTxBcastRate,
    eMocaTxBcastPowerReduction,
    eMocaQAM256Capable,
    eMocaPacketAggregationCapability,
    eMocaAssociatedDeviceNumberOfEntries
} EMoCAInterfaceMembers ;

typedef enum EAPICall
{
    eMocaStatusInterface=0,
    eMocaStatusEntry,
    eMocaConfig,
    eMocaInitParams,
    eMocaDefined
...
class MoCADevice {
    ...
    MoCADevice(int dev_id);
    ~MoCADevice() {};
public:
    static class MoCADevice *getInstance(int dev_id);
    static void closeInstance(MoCADevice *);
    static void closeAllInstances();

    void* getContext();
};

class hostIf_MoCAInterface {

    static  GHashTable  *ifHash;
    static GMutex *m_mutex;

    MoCAInterface mIterface;

    int dev_id;

    int get_Device_MoCA_Interface_Fields(EMoCAInterfaceMembers ,EAPICall, HOSTIF_MsgData_t* );
    ...
    int curNumOfDevices;
    bool backupEnable ;
    int backupLastChange ;
    int backupMaxBitRate ;
    int backupMaxIngressBW ;
    int backupMaxEgressBW ;
    int backupNetworkCoordinator ;
    int backupNodeID ;
    bool backupMaxNodes ;
    bool backupPreferredNC ;
    int backupBackupNC ;
    bool backupPrivacyEnabledSetting ;
    bool backupPrivacyEnabled ;
    int backupLastOperFreq ;
    int backupTxPowerLimit ;
    int backupPowerCntlPhyTarget ;
    int backupBeaconPowerLimit ;
    int backupTxBcastRate ;
    int backupTxBcastPowerReduction ;
    bool backupQAM256Capable ;
    int backupPacketAggregationCapability ;
    int backupAssociatedDeviceNumberOfEntries ;
    char backupStatus[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupMACAddress[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupFirmwareVersion[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupHighestVersion[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupCurrentVersion[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupFreqCapabilityMask[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupFreqCurrentMaskSetting[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupFreqCurrentMask[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupKeyPassphrase[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupNetworkTabooMask[TR69HOSTIFMGR_MAX_PARAM_LEN+1];
    char backupNodeTabooMask[TR69HOSTIFMGR_MAX_PARAM_LEN+1];

    bool bCalledEnable;
    bool bCalledStatus;
    bool bCalledLastChange;
    bool bCalledMACAddress;
    bool bCalledFirmwareVersion;
    bool bCalledMaxBitRate;
    bool bCalledMaxIngressBW;
    bool bCalledMaxEgressBW;
    bool bCalledHighestVersion;
    bool bCalledCurrentVersion;
    bool bCalledNetworkCoordinator;
    bool bCalledNodeID;
    bool bCalledMaxNodes;
    bool bCalledPreferredNC;
    bool bCalledNC;
    bool bCalledPrivacyEnabledSetting;
    bool bCalledPrivacyEnabled;
    bool bCalledFreqCapabilityMask;
    bool bCalledFreqCurrentMaskSetting;
    bool bCalledFreqCurrentMask;
    bool bCalledLastOperFreq;
    bool bCalledKeyPassphrase;
    bool bCalledTxPowerLimit;
    bool bCalledPowerCntlPhyTarget;
    bool bCalledBeaconPowerLimit;
    bool bCalledNetworkTabooMask;
    bool bCalledNodeTabooMask;
    bool bCalledTxBcastRate;
    bool bCalledTxBcastPowerReduction;
    bool bCalledQAM256Capable;
    bool bCalledPacketAggregationCapability;
    bool bCalledAssociatedDeviceNumberOfEntries;
...
public:
    ...
    static hostIf_MoCAInterface *getInstance(int dev_id);

    static void closeInstance(hostIf_MoCAInterface *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_Enable(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_Alias(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_LowerLayers(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_PreferredNC(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_PrivacyEnabledSetting(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_FreqCurrentMaskSetting(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_TxPowerLimit(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_PowerCntlPhyTarget(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_KeyPassphrase(HOSTIF_MsgData_t *);
    ...
    * @return Returns 0 on success, otherwise will return the appropriate error code.
    */
    int set_Device_MoCA_Interface_BeaconPowerLimit(HOSTIF_MsgData_t *);
